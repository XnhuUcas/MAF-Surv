...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='Datasets/LUAD/RF80/', help="datasets")
    parser.add_argument('--datatype', default='luad.pkl', help="datatype")
    parser.add_argument('--model_save', type=str, default=r"experiment/LUAD/CAMR/models",help='models are saved here')
    parser.add_argument('--results', type=str, default=r"experiment/LUAD/CAMR/results", help='results are saved here')
    parser.add_argument('--exp_name', type=str, default='LGG/', help='name of the project. It decides where to store samples and models')
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--model_name', type=str, default='CAMR', help='mode')
    ...
    parser.add_argument('--tsne_test_size', type=float, default=0.2, help='test ratio for standalone t-SNE split')
    parser.add_argument('--tsne_random_state', type=int, default=111, help='random seed for standalone t-SNE split')
